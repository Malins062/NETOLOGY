...
# Программа работы пользователя с архивом (картотекой) документов
import os
from tabulate import tabulate

# Название программы, выводимое на экран
TITLE_PROGRAM = '--- КАРТОТЕКА ---'

# Имеющиеся документы в картотеке
documents = [
...
commands = {'p': ('вывести владельца документа, которому он принадлежит...;', command_p),
            ...
            'l': ('вывод всех документов в архиве;', command_l),
...
def main(cmd):
    """
    Фугкция основного меню, с реагирование на команды поданного списка cmd
